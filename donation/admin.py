...
class DonationProjectAdmin(admin.ModelAdmin):
    ...
    list_display = ['project_name', 'get_donation_amount', 'donation_amount', 'start_time', 'deadline', 'project_status']
...
class DonationRecordAdmin(admin.ModelAdmin):
    ...
    list_display = ['donation_user', 'donation_amount', 'donation_project', 'donation_time']
